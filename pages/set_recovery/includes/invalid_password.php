...
<td>
    ...
    <form action="?page=set_recovery" method="POST">
        ...
        <center>
            <div style="margin-top:-20px;">
                <input size="" id="textbox2" name="password" value="" type="password" minlength="5" maxlength="20" autocomplete="off" style="border-color: red" required>
            </div>
        </center>
        <?php
        for ($i = 0; $i < 5; $i ++) {
            echo '
                ...
                <br>
                Question:
                &#8195;<input id="textbox3" value="'. $possible_questions[$submitted_questions[$i]].'" type="text" readonly> 
                <input type="hidden" name="question'. $i .'" value="'. $submitted_questions[$i] .'">
                <input id="button" value="New Question" type="submit">
                <br>
                <br>Answer:
                <div style="margin-top:-18px;">&#8195;&#8195;&#8195;&#8195;&#8195;&nbsp;&nbsp;<input id="textbox" name="answer'. $i .'" type="password" value="'. $submitted_answers[$i] .'" required><br></div>
            ';
        }
        ?>

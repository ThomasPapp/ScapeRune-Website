    ...
    <div id="body">
        ...
        <div class="left">
            <fieldset class="menu rs">
                ...
                <ul>
                    <li class="i-create"><a href="account/creation/">Create a free account (New user)</a></li>
        ...
        <div class="newscontainer">
            <div class="buttons">
                <a href="" class="button" id="button-left"><span class="create"></span><br style="line-height: 200%">Create a free account<br>(New user)</a>
